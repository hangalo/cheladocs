        ...
        <div class="container">
            ...
            <div id="contentor">
                <div id="banner">
                    ...
                    <a href="../RequerenteServlet?comando=imprimir_todos" class="btn btn-info" role="button">Gerar Relatório</a>
                    ...
                    <table id="minhaTabela" class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="../RequerenteServlet?comando=eliminar&id_requerente=<%=r.getIdRequerente()%>"><img src="../imagens/delete.png"/></a></td>
                                <td><a href="../RequerenteServlet?comando=imprimir_by_id&id_requerente=<%=r.getIdRequerente()%>"><img src="../imagens/print.png"/></a></td>
                            <% cont = cont + 1; } %>
                            </tr>
                        </tbody>
                    </table>
